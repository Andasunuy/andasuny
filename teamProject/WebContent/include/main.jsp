...
<div class="wrapper row3">
		<div id="introblocks" class="hoc clear">
			...
			<ul class="nospace group">
				<li class="one_quarter first">
					<article>
						<a class="btn" href="#"><i class="tr tr-airplane37"></i></a>
						<h4 class="heading underline center">
				...
				<li class="one_quarter">
					<article>
						<a class="btn" href="#"><i class="tr tr-transport68"></i></a>
						<h4 class="heading underline center">
				...
				<li class="one_quarter">
					<article>
						<a class="btn" href="#"><i class="tr tr-car167"></i></a>
						<h4 class="heading underline center">
							<a href="#">Book a Car</a>
						</h4>
					</article>
				...
				<li class="one_quarter">
					<article>
						<a class="btn" href="#"><i class="tr tr-building90"></i></a>
						<h4 class="heading underline center">
	...
	<div class="wrapper row5">
		<section id="holtypes" class="hoc clear">
			...
			<ul class="nospace group">
				<li class="one_third first">
					<article>
						<a class="btn" href="#"><i class="tr tr-bicycle14"></i></a>
				...
				<li class="one_third">
					<article>
						<a class="btn" href="#"><i class="tr tr-hiking1"></i></a>
				...
				<li class="one_third">
					<article>
						<a class="btn" href="#"><i class="tr tr-massage2"></i></a>
				...
				<li class="one_third first">
					<article>
						<a class="btn" href="#"><i class="tr tr-golf22"></i></a>
				...
				<li class="one_third">
					<article>
						<a class="btn" href="#"><i class="tr tr-watercraft"></i></a>
				...
				<li class="one_third">
					<article>
						<a class="btn" href="#"><i class="tr tr-person205"></i></a>
	...
	<div class="wrapper bgded overlay" style="background-image: url('images/demo/backgrounds/02.png');">
		<div class="hoc container clear">
			...
			<p class="btmspace-50">
				Condimentum nunc at faucibus ex phasellus ac efficitur lorem ut. <a href="#">View All Destinations &raquo;</a>
			</p>
				...
				<li class="one_quarter first">
					<figure class="elementwrapper">
						...
						<figcaption class="group">
							...
							<a href="#" class="fl_right"><i class="fa fa-eye"></i></a>
						</figcaption>
					</figure>
				</li>
				<li class="one_quarter">
	...
	<div class="wrapper row3">
		<div class="hoc container clear">
			...
			<p class="btmspace-50">
				Imperdiet lacinia placerat in sapien vivamus ac dolor felis pellentesque. <a href="#">View All Deals &raquo;</a>
			</p>
